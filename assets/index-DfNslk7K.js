...
`;document.addEventListener("DOMContentLoaded",()=>{document.getElementById("header").innerHTML=k,document.getElementById("footer").innerHTML=w;const d=document.getElementById("menu-toggle"),a=document.getElementById("mobile-menu"),n=document.getElementById("overlay");d.addEventListener("click",()=>{i()}),n.addEventListener("click",()=>{i(!1)});function i(t=null){t===null?(d.classList.toggle("open"),a.classList.toggle("translate-x-0"),a.classList.toggle("translate-x-full"),n.classList.toggle("opacity-100"),n.classList.toggle("pointer-events-none")):t===!1&&(d.classList.remove("open"),a.classList.remove("translate-x-0"),a.classList.add("translate-x-full"),n.classList.remove("opacity-100"),n.classList.add("pointer-events-none"))}const e={"/pestxperts-1/":"/pestxperts-1/src/pages/home.html","/pestxperts-1/services":"/pestxperts-1/src/pages/services.html","/pestxperts-1/faq":"/pestxperts-1/src/pages/faq.html","/pestxperts-1/contact":"/pestxperts-1/src/pages/contact.html"},s=document.querySelector("#app");let r=null;async function f(t){try{const l=await(await fetch(e[t]||e["/pestxperts-1/"])).text();s.innerHTML=l,i(!1),m()}catch(o){console.error("Σφάλμα φόρτωσης σελίδας:",o),s.innerHTML="<p>Σφάλμα φόρτωσης σελίδας. Παρακαλώ δοκιμάστε ξανά.</p>"}}function m(){r&&clearInterval(r),x(),h()}function x(){const t=document.querySelectorAll(".carousel-item");if(t.length===0)return;let o=0;function l(y){t.forEach((b,L)=>{b.style.opacity=L===y?"1":"0"})}function c(){o=(o+1)%t.length,l(o)}function u(){o=(o-1+t.length)%t.length,l(o)}l(o);const p=document.getElementById("nextBtn"),g=document.getElementById("prevBtn");p&&p.addEventListener("click",c),g&&g.addEventListener("click",u),r=setInterval(c,5e3)}function h(){const t=document.querySelectorAll(".faqBtn");t.length>0&&t.forEach((o,l)=>{o.addEventListener("click",function(){const c=document.getElementById(`answer${l+1}`),u=o.querySelector("svg");c&&u&&(c.classList.toggle("hidden"),u.classList.toggle("rotate-180"))})})}function v(t){if(t.target.matches("[data-link]")){t.preventDefault();const o=t.target.getAttribute("href");history.pushState(null,"",o),f(o)}}window.addEventListener("popstate",()=>f(location.pathname)),document.addEventListener("click",v),f(location.pathname)});
